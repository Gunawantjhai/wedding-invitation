  ...
  en: {
    ...
    copy: {
      ...
      rsvp: {
        ...
        title: "RSVP",
        subtitle: "Please confirm your attendance before September 1, 2027 so we can prepare well.",
  ...
  ch: {
    ...
    copy: {
      ...
      rsvp: {
        eyebrow: "请您确认",
        title: "回复函",
        subtitle: "请您于 2027 年 9 月 1 日前确认出席，我们将为此做好准备。",
        successTitle: "谢谢您！",
